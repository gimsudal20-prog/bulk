...
def _save_report_stats_and_breakdowns(
    ...
    *,
    ...
    criterion_report_df: pd.DataFrame | None = None,
    criterion_conversion_report_df: pd.DataFrame | None = None,
    ...
    return collector_runner_mod._save_report_stats_and_breakdowns(
        ...
        criterion_report_df=criterion_report_df,
        criterion_conversion_report_df=criterion_conversion_report_df,
...
def process_account(engine: Engine, customer_id: str, account_name: str, target_date: date, skip_dim: bool = False, fast_mode: bool = False, collect_mode: str = "sa_with_device", sa_scope: str = "full", shopping_only: bool = False, skip_time_age: bool = False):
    return collector_runner_mod.process_account(
        ...
        build_adgroup_to_campaign_map_fn=build_adgroup_to_campaign_map,
